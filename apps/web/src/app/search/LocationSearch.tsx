    ...
    <div ref={containerRef} className={`relative w-full max-w-md ${className}`}>
      <div className="relative flex items-center">
        ...
        <input
          ...
          className="w-full rounded-lg border border-slate-700/80 bg-[#0c1322]/90 py-2 pl-10 pr-10 text-xs text-slate-100 placeholder-slate-400 shadow-inner backdrop-blur focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500 font-mono"
        />
        {query && (
          <button
            onClick={() => {
